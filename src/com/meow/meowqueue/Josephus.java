...
//            public static <E> E Josephus(CircularQueueADT<E> queue, int k) {
...
//
//
//             public static <E> CircularQueueADT<E> buildQueue(E a[ ]) {
//         CircularQueueADT<E> queue = new LinkedCircularQueue<>();
